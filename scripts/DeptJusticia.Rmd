...
deli2020 <- read_excel("data/Departamento_de_Justicia/djDelitos2020.xlsx") %>% 
...
deli2021 <- read_excel("data/Departamento_de_Justicia/djDelitos2021.xlsx") %>%
  convert_mixed_columns() %>%
...
deli2022 <- read_excel("data/Departamento_de_Justicia/djDelitos2022.xlsx") %>%
  convert_mixed_columns() %>%
...
deli2023 <- read_excel("data/Departamento_de_Justicia/djDelitos2020.xlsx") %>%
  convert_mixed_columns() %>%
