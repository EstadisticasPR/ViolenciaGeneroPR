---
title: "Visualizaciones Preliminares: Negociado de Policia"
...
desp2020 <- read_excel("data/Negociado_de_Policia/npprDesp2020.xlsx") %>% mutate(Año = "2020") %>% rename(Categoria = Mes,Total = `Total Año 2020`)

# importando data del 2021
desp2021 <- read_excel("data/Negociado_de_Policia/npprDesp2021.xlsx") %>% mutate(Año = "2021") %>% rename(Categoria = Mes, Total = `Total Año 2021`)

# importando data del 2022
desp2022 <- read_excel("data/Negociado_de_Policia/npprDesp2022.xlsx") %>% mutate(Año = "2022") %>% rename(Categoria = Mes, Total = `Total Año 2022`)
...
## Incidentes
```{r}
inci2021 <- read_excel("data/Negociado_de_Policia/NPPRincidentes_2021.xlsx") %>% 
  rename_with(~gsub("2021", "",.), contains("2021")) %>%
  rename_at(vars(2), ~ "Población") %>% 
  mutate(Año = "2021")

# faltan datos para el 2022
inci2022 <- read_excel("data/Negociado_de_Policia/NPPRincidentes_2022.xlsx") %>% 
...
familiar <- read_excel("data/Negociado_de_Policia/npprRelFam.xlsx") %>%
  rename(Valor = Familiar) %>%
  mutate(Tipo = "Familiar")

# importando la data de relaciones no familiares
nofamiliar <- read_excel("data/Negociado_de_Policia/npprRelNoFam.xlsx") %>%
