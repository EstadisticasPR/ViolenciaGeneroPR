...
library(tidyverse)
library(readxl)
setwd("~/Estadisticas-Sobre-Violencia-de-Genero-en-Puerto-Rico/data/Departamento_de_Familia/")
```
...
file_list <- list.files("~/Estadisticas-Sobre-Violencia-de-Genero-en-Puerto-Rico/data/Departamento_de_Familia", pattern = "\\.xlsx$", full.names = TRUE)

# Crear una lista para almacenar los datos de los archivos
data_list <- list()

# Leer cada archivo en la lista y almacenar los datos en la lista de datos
...
```{r}
# camino de los datos del Departamento de Familia
path <- "~/Estadisticas-Sobre-Violencia-de-Genero-en-Puerto-Rico/data/Departamento_de_Familia/"
