...
ggplot(dfMalt_long, aes(x = Año, y = Casos, color = `Tipo de Maltrato`, linetype = Sexo, group_by = Sexo)) +
  geom_line(size = 1) +
  geom_point(size = 3) +
  labs(title = "Casos de Maltrato por Año y Tipo", x = "Año", y = "Casos") +
  theme_minimal() +
...
ggplot(dfMalt_long, aes(x = Año, y = Casos, color = Sexo, linetype = Sexo)) +
  geom_line(size = 1) +
  geom_point(size = 3) +
  labs(title = "Casos de Maltrato por Año y Tipo", x = "Año", y = "Casos") +
  facet_wrap(~`Tipo de Maltrato`, scales = "free_y", ncol = 2) +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
dfMalt_year <- subset(dfMalt, Año == as.character(year_selected))

# Gráfico de barras apiladas para el año seleccionado
ggplot(dfMalt_year, aes(x = `Tipo de Maltrato`, y = Casos, fill = Sexo)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = paste("Distribución de Tipos de Maltrato en el Año", year_selected),
