...
```{r}
# violencia domestica
opmFemiVD <- read_excel("data/Oficina_de_procuradora_de_mujeres/opmFemiVD.xlsx") # año, asesinatos, tasa x100k 
```
...
opm_casos <-  read_excel("data/Oficina_de_procuradora_de_mujeres/opmPartMes.xlsx") %>%
  mutate(
...
# Victimas por Genero
```{r}
opmVic_long <- read_excel("data/Oficina_de_procuradora_de_mujeres/opmVicGraf.xlsx") %>% 
...
```{r}
opmMedio_long <- read_excel("data/Oficina_de_procuradora_de_mujeres/opmMedio.xlsx") %>% 
...
```{r}
read_excel("data/Oficina_de_procuradora_de_mujeres/opmServiciosMes.xlsx") # mes, año, tipo de servicio, # ofrecidos
```
